<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="AddProducts.aspx.cs" Inherits="FlowerShop.admin.AddProducts" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>新品上架</title>
    <link href="../css/Master.css" rel="stylesheet" />
    <link href="../css/UserShow.css" rel="stylesheet" />
    <link href="../css/AddProducts.css" rel="stylesheet" />
    <link href="../js/AddProducts.js" />
</asp:Content>
